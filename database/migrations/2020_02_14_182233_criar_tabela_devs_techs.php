...
class CriarTabelaDevsTechs extends Migration
{
    ...
    public function up()
    {
        Schema::create('devs_techs', function (Blueprint $table) {
            ...
            $table->foreign('id_dev', 'dev_id_dev_techs')->references('id')->on('devs')->onDelete('set null');
            $table->foreign('id_tech', 'tech_id_dev_techs')->references('id')->on('techs')->onDelete('set null');
        });
    }
